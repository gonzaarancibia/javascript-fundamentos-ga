...
// - Si es socio, tiene 20% de descuento
// - Si no es socio pero es feriado, tiene 10% de descuento 
// - De lo contrario, paga el precio completo
// Sugerencia: Usa operadores ternarios anidados
// Sugerencia: Para descuento del 20% multiplica por 0.8, para descuento del 10% multiplica por 0.9
// let precioFinal = 
...
//let mensajeCarrito = `Tu carrito tiene ${}`; 
